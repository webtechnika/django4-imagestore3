    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='images', verbose_name='User', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL)),
            ],
            options={
                'ordering': ('order', 'id'),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(blank=True, to=swapper.get_model_name('imagestore', 'Album'), help_text='Select an album to add these images to. leave this empty to create a new album from the supplied title.', null=True, on_delete=models.SET_NULL)),
            ],
            options={
                ''
        ...
        migrations.AddField(
            model_name='image',
            name='album',
            field=models.ForeignKey(related_name='images', verbose_name='Album', blank=True, to=swapper.get_model_name('imagestore', 'Album'), null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
    ]
